...
# Kayit dizinini **gecici bir klasore** al: test oyuncunun gercek
# kaydini asla ezmemeli. `save.py` bu degiskeni okuyor.
_TEMP = tempfile.mkdtemp(prefix="lore_kayit_testi_")
